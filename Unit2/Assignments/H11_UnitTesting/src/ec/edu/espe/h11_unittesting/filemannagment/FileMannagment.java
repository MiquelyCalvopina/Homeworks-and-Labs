 ...
 */
package ec.edu.espe.h11_unittesting.filemannagment;
...
public class FileMannagment {
    ...
    public void modify(File file, String name, String inString, boolean check){
        ArrayList<String> line = new ArrayList<String>();
        line = reads(file);
